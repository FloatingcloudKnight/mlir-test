...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/d/llvm/mytoy/build/antlr4_runtime/src/antlr4_runtime'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/d/llvm/mytoy/build/antlr4_runtime/src/antlr4_runtime'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
